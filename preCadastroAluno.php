...
<body>
    ...
    <section class="formulario-colaborador container-fluid" id="formulario-colaborador">
        <article class="row">
            <h2>Pré-Cadastro Aluno</h2>
            <form class="col-12 col-md-5 col-form" method="POST" action="enviarAluno.php"
                ...
                <div class="input-group mb-4">
                    <div class="col-12 col-md-8 mb-2 mb-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Nome Completo" name="nomeResponsavel" id="nome" required>
                    </div>
                    <div class="col-5 col-md-4 mb-2 mb-md-4">
                        <label for="data-nascimento" class="form-label">Nascimento*</label>
                        <input type="text" class="form-control" placeholder="00/00/0000" name="nascResponsavel"id="data-nascimento" required>
                    </div>
                    <div class="col-7 col-md-3">
                        <label for="cpf" class="form-label">CPF*</label>
                        <input type="text" class="form-control" placeholder="000.000.000-00" name="docResponsavel" id="cpf" required>
                    </div>

                    <div class="col-5 col-md-4">
                        <label for="telefone" class="form-label">Celular*</label>
                        <input type="text" class="form-control" name="foneResponsavel" id="telefone" placeholder="(00)00000-0000"
                            required>
                    </div>

                    <div class="col-7 col-md-5">
                        <label for="email-inp" class="form-label">E-mail</label>
                        <input type="email" class="form-control" name="emailResponsavel" id="email-inp"
                ...
                <div class="col-6 mb-4">
                    ...
                    <div class="form-check col-6">
                        <input class="form-check-input" type="radio" name="sexoResponsavel" value="M" id="masculinoResponsavel" checked>
                        <label class="form-check-label" for="masculinoResponsavel">Masculino</label>
                    </div>
                    <div class="form-check  col-6">
                        <input class="form-check-input" type="radio" name="sexoResponsavel" value="F" id="femininoResponsavel">
                ...
                <div class="input-group mb-4">
                    <div class="col-12 col-md-8 mb-2 mb-md-4">
                        <label for="nome" class="form-label">Nome*</label>
                        <input type="text" class="form-control" placeholder="Nome Completo" name="nomeAluno" id="nome" required>
                    </div>
                    <div class="col-5 col-md-4 mb-2 mb-md-4">
                        <label for="data-nascimento" class="form-label">Nascimento*</label>
                        <input type="text" class="form-control" placeholder="00/00/0000" name="nascAluno"
                            id="data-nascimento-aluno" required>
                    </div>
                    <div class="col-7 col-md-3">
                        <label for="cpf" class="form-label">CPF</label>
                        <input type="text" class="form-control" placeholder="000.000.000-00" name="docAluno" id="cpf-aluno">
                    </div>

                    <div class="col-5 col-md-4">
                        <label for="telefone" class="form-label">Celular</label>
                        <input type="text" class="form-control" name="foneAluno" id="telefone-aluno" placeholder="(00)00000-0000">
                    </div>

                    <div class="col-7 col-md-5">
                        <label for="email-inp" class="form-label">E-mail</label>
                        <input type="email" class="form-control" name="emailAluno" id="email-inp"
                            placeholder="nome@exemplo.com">
                    </div>
                </div>
                ...
                <div class="col-6 mb-4">
                    ...
                    <div class="form-check col-6">
                        <input class="form-check-input" type="radio" name="sexoAluno" value="M" id="masculinoAluno" checked>
                ...
                <div class="mb-3 d-flex gap-2">
                    <input type="checkbox" name="termoResponsavel" id="termoResponsavel">
                    <label for="termoResponsavel" class="fw-semibold">Eu responsavel do aluno me comprometo a estar presente em todas atividades propostas</label>
                </div>
...
<script>
    ...
    $("#data-nascimento-aluno").mask("00/00/0000");
    $("#telefone").mask("(00)00000-0000");
    $("#telefone-aluno").mask("(00)00000-0000");
    $("#cep").mask("00000-000");
    $("#cpf").mask("000.000.000-00");
    $("#cpf-aluno").mask("000.000.000-00");
