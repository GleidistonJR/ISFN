            ...
            <form class="col-12 col-lg-8 col-form my-5 p-0" method="POST" action="process/saveEdit.php">
                ...
                <div class="input-group">
                    ...
                    <div class="col-7 col-md-3 mb-2 mb-md-1">
                        ...
                        <input type="text" class="form-control" id="cpfInp" placeholder="000.000.000-00" value="<?php echo $docResponsavel?>" name="docResponsavel" id="docResponsavel" disabled>
                    </div>
                ...
                <div class="input-group mb-2">
                    <div class="col-6 mb-2">
                        ...
                        <div class="form-check col-6">
                            <input class="form-check-input" type="radio" name="sexoAluno" value="M" id="sexoAluno" checked>
